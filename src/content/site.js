export const site = {
  ...
  experience: [
    ...
    {
      initials: "T",
      role: "Software Engineer - Trovara",
      company: "Personal Project",
      companyUrl: null,
      period: "2023 - Present",
      bullets: [
        "Architected and developed Trovara, an AI-powered cross-platform notes app with MVVM + Repository pattern and offline-first ObjectBox storage",
        "Built a full RAG pipeline for semantic chat over notes — vector search, query rewriting, and multi-LLM support (Gemini / OpenAI / OpenRouter)",
        "Implemented a knowledge graph linking related notes, quiz generation, and an Insights analytics tab; added imports from Obsidian, Notion, and Storypad",
        "Delivered bidirectional Google Drive sync with conflict resolution, English/Khmer i18n, and a Pro tier with Google Play billing",
        "Set up Shorebird OTA updates and a CI/CD pipeline with automated builds and credential management using SOPS",
      ],
    },
  ],
  testimonials: [
